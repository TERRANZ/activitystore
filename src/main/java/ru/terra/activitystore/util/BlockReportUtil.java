...
public class BlockReportUtil {
    ...
    private Map<Integer, Integer> listsCount = new HashMap<Integer, Integer>();
                    ...
                    switch (cell.getType()) {
                        ...
                        case 4:// list
                        {
                            ...
                            for (String id : list) {
                                ...
                                if (!listsCount.containsKey(listId))
                                    listsCount.put(listId, 0);
                                value += contoller.getListValue(listId) + ", ";
                                listsCount.put(listId, listsCount.get(listId) + 1);
                            }
