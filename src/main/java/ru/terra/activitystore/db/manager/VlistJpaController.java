...
public class VlistJpaController implements Serializable {
    ...
    public void create(Vlist vlist) {
        if (vlist.getCreationDate() == null)
            vlist.setCreationDate(new Date());
        if (vlist.getUpdateDate() == null)
            vlist.setUpdateDate(new Date());
    ...
    public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException {
        ...
        try {
            ...
            for (ListVal listValListOrphanCheckListVal : listValListOrphanCheck) {
                ...
                illegalOrphanMessages.add("This Vlist (" + vlist + ") cannot be destroyed since the ListVal " + listValListOrphanCheckListVal
                        + " in its listValList field has a non-nullable listId field.");
            }
            if (illegalOrphanMessages != null) {
                throw new IllegalOrphanException(illegalOrphanMessages);
            }
